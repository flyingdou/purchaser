	...
	<script type="text/javascript">
		var vue = new Vue({
			...
			methods: {
				...
				init: function () {
					if ("${user}" == "") {
						location.href = "user/checkLogin.pur?redirectURL=" + encodeURI("purchaser/recruit.jsp");
					}
					
					// 初始化顶部栏选项
					var nav_text_list = ["招聘信息","求职信息"];
				...
				getContentListBySetTop: function () {
					// 请求服务端数据
					var param = {contentType : "recruit", setTop : 1}
					var callback = res =>{
				...
				getContentList: function () {
					// 请求服务端数据
					var param = {contentType : "recruit", classification : this.currentIndex, setTop : 0}
					var callback = res => {
