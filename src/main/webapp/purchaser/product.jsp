	...
	<script type="text/javascript">
		var vue = new Vue({
			...
			methods: {
				...
				init: function () {
					if ("${user}" == "") {
						location.href = "user/checkLogin.pur?redirectURL=" + encodeURI("purchaser/product.jsp");
					}
				...
				getContentListBySetTop: function () {
					// 请求服务端数据
					var param = {contentType : "product", setTop : 1}
					var callback = res =>{
				...
				getContentList: function () {
					// 请求服务端数据
					var param = {contentType : "product", classification : this.currentIndex, setTop : 0}
					var callback = res => {
